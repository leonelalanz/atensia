...
import { Plus, Download, FileText, Search, CreditCard } from 'lucide-react';
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            onClick={() => { setForm({ company_id: '', plan: 'basic', status: 'active', start_date: new Date().toISOString().slice(0, 10), end_date: '', amount: '0', currency: 'USD', admin_name: '', admin_email: '', admin_password: '' }); setError(''); setModalOpen(true); }}
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Nueva Suscripción" size="md">

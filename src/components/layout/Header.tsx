...
import { Sun, Moon, Bell, LogOut, Plus, ChevronDown, Menu, Loader2 } from 'lucide-react';
...
export default function Header({ onMenuToggle }: HeaderProps) {
  ...
  return (
    <header className="h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 sm:px-6 flex-shrink-0 z-10">
      ...
      <Modal open={showLogoutConfirm} onClose={() => !loggingOut && setShowLogoutConfirm(false)} title="Cerrar Sesión">
